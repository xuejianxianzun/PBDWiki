...
- By default, the downloader [Slows Down Crawling Speed](/en/Settings-More-Crawl?id=slow-down-crawling-speed). When crawling many works, it sends requests at intervals. This feature is enabled by default.
...
This works because the downloader has a [Resume Download Function](/en/Common-Questions?id=does-it-support-resume-download), which can recover incomplete download tasks on the same URL.
...
See details: [Export Crawl Results](/en/Buttons-Download?id=export-crawl-results)