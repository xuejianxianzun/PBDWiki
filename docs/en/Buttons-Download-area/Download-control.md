...
<button id="startDownload" type="button" class="hasRippleAnimation settingsPanelActionBtn" data-btn-emphasis="primary" data-btn-intent="success"><span data-xztext="_开始下载">Start download</span><span class="ripple"></span></button>
...
<button id="pauseDownload" type="button" class="hasRippleAnimation settingsPanelActionBtn" data-btn-emphasis="primary" data-btn-intent="warning"><span data-xztext="_暂停下载">Pause download</span><span class="ripple"></span></button>
...
<button id="stopDownload" type="button" class="hasRippleAnimation settingsPanelActionBtn" data-btn-emphasis="primary" data-btn-intent="danger"><span data-xztext="_停止下载">Stop download</span><span class="ripple"></span></button>
