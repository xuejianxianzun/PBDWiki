...
- `Copy TXT`: Click it, and the downloader will copy some metadata to the clipboard, matching the content of the TXT file generated by the [Save work metadata](/en/Settings-More-Download?id=Save-work-metadata) feature.
...
?> This feature depends on the [Preview work](/en/Settings-More-Enhancements?id=Preview-work) feature. If the "Preview work" feature is disabled, this feature will not work. This is mainly to simplify code and avoid multiple requests for work data without caching.
...
You can find detailed information about the image viewer here: [Image Viewer](#/en/Convenient-Features?id=Image-Viewer).
...
5. [Bookmark after download](/en/Settings-Download?id=Bookmark-after-download) feature.
