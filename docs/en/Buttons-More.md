...
- When using this feature to add bookmarks, whether they are public or tagged follows the settings in [Downloader’s Bookmark Button (✩)](/en/Settings-More-Enhancements?id=Downloader’s-Bookmark-Button-✩).
...
- [Crawl How Many Pages](/en/Settings-Crawl?id=Crawl-How-Many-Pages)
...
- [Must Include Tags](/en/Settings-Crawl?id=Must-Include-Tags)
- [Must Not Include Tags](/en/Settings-Crawl?id=Must-Not-Include-Tags)
- [User Blocklist](/en/Settings-More-Crawl?id=User-Blocklist)
