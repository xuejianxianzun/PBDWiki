...
You can modify this button’s behavior in the [Downloader’s Bookmark Button (✩)](/en/Settings-More-Enhance?id=downloader-s-bookmark-button-✩) settings: whether to add tags and whether the bookmark is public.
...
See detailed explanation: [Long press the right mouse button on the thumbnail to display the large image](/en/Settings-More-Enhance?id=view-large-image-by-long-pressing-right-mouse-button-on-thumbnail)
...
See detailed explanation: [Show download button on thumbnail](/en/Settings-More-Enhance?id=display-download-button-on-work-thumbnails)
...
See detailed explanation: [In the multi-image work page, display the thumbnail list](/en/Settings-More-Enhance?id=display-thumbnail-list-on-multi-image-work-pages)
...
See detailed explanation: [Add Quick Search Area on Search Pages](/en/Settings-More-Enhance?id=add-quick-search-area-on-search-pages)
