...
<div class="option settingsPanel_optionCard new" data-no="49" data-pin-bound="true" style="display: flex;">
  <a href="/#/en/Settings-Naming/Remove-special-characters?flag=49" target="_blank" class="settingNameStyle" data-bind-click="true">
...
<div class="option settingsPanel_optionCard" data-no="50" data-pin-bound="true" style="display: flex;">
  <a href="/#/en/Settings-Naming/Remove-special-characters?flag=50" target="_blank" class="has_tip settingNameStyle" data-xztip="_移除用户名中的at和后续字符的说明" data-tip="For example：Anmi@画集発売中 → Anmi" data-bind-click="true">
