...
<div class="option settingsPanel_optionCard new" data-no="46" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/序号?flag=46" target="_blank" class="has_tip settingNameStyle" data-xztip="_序号起始值的说明" data-tip="设置图片的序号从 0 开始还是从 1 开始" data-bind-click="true">
...
<div class="option settingsPanel_optionCard" data-no="47" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/序号?flag=47" target="_blank" class="has_tip settingNameStyle" data-xztip="_第一张图不带序号说明" data-tip="去掉每个作品第一张图的序号。例如 80036479_p0 变成 80036479" data-bind-click="true">
...
<div class="option settingsPanel_optionCard" data-no="48" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/序号?flag=48" target="_blank" class="has_tip settingNameStyle" data-xztip="_在序号前面填充0的说明" data-tip="这可以解决一些软件不能正确的按照文件名来排序文件的问题。" data-bind-click="true">
