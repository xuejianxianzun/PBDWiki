...
<div class="option settingsPanel_optionCard" data-no="32" data-pin-bound="true" style="display: flex;">
  <span class="fileNameRuleLine1">
    <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=32" target="_blank" class="settingNameStyle optionName" data-xztext="_图像作品的命名规则" data-bind-click="true">图像作品的<span class="key">命名</span>规则</a>
...
如果你觉得第一张图片不需要序号，想把 `44920385_p0` 变成 `44920385`，可以启用 [第一张图不带序号](/zh-cn/设置-命名/序号?id=第一张图不带序号) 的选项。
...
<div class="option settingsPanel_optionCard new" data-no="33" data-pin-bound="true" style="display: flex;">
  <span class="fileNameRuleLine1">
    <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=33" target="_blank" class="settingNameStyle optionName" data-xztext="_小说的命名规则" data-bind-click="true">小说的<span class="key">命名</span>规则</a>
    <span class="fileNameRuleBtnsArea">
...
<div class="option settingsPanel_optionCard" data-no="34" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=34" target="_blank" class="settingNameStyle" data-xztext="_在不同的页面类型中使用不同的命名规则" data-bind-click="true">在不同的页面类型中使用<span class="key">不同</span>的命名规则</a>
...
<div class="option settingsPanel_optionCard" data-no="35" data-pin-bound="true">
  <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=35" target="_blank" class="settingNameStyle" data-xztext="_如果作品含有某些标签则对这个作品使用另一种命名规则" data-bind-click="true">如果作品含有某些<span class="key">特定标签</span>，则对这个作品使用另一种命名规则</a>
...
<div class="option settingsPanel_optionCard" data-no="36" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=36" target="_blank" class="settingNameStyle" data-xztext="_合并系列小说时的命名规则" data-bind-click="true">合并系列小说时的<span class="key">命名</span>规则</a>
...
<div class="option settingsPanel_optionCard" data-no="37" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=37" target="_blank" class="settingNameStyle" data-xztext="_标签分隔符号" data-bind-click="true">标签<span class="key">分隔</span>符号</a>
...
<div class="option settingsPanel_optionCard" data-no="38" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=38" target="_blank" class="settingNameStyle" data-xztext="_日期格式" data-bind-click="true">日期和时间<span class="key">格式</span></a>
...
<div class="option settingsPanel_optionCard" data-no="39" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-命名/文件夹和文件的名字?flag=39" target="_blank" class="settingNameStyle" data-bind-click="true">
