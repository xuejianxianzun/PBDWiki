...
<div class="option pinned" data-no="55" style="display: flex;"><button type="button" class="pinButton" data-title="_置顶">📌</button>
      <a href="https://xuejianxianzun.github.io/PBDWiki/#/zh-cn/设置-更多-增强?flag=55" target="_blank" class="has_tip settingNameStyle" data-xztip="_预览作品的说明" data-tip="当鼠标放在图片的缩略图上时，下载器可以显示更大的图片。">
      ...
      <span class="subOptionWrap" data-show="PreviewWork" style="display: inline-flex;">
        ...
        <span class="verticalSplit"></span>
        <button type="button" class="gray1 textButton toggleArea" data-toggle-target="#previewWorkShortcutTip" data-for-no="55" data-xztext="_快捷键列表">快捷键列表</button>
      </span>
    </div>
...
<div class="option new" data-no="102" style="display: flex;"><button type="button" class="pinButton" data-title="_置顶">📌</button>
      <a href="https://xuejianxianzun.github.io/PBDWiki/#/zh-cn/设置-更多-增强?flag=102" target="_blank" class="settingNameStyle has_tip" data-xztip="_缩略图上按钮的位置的说明" data-tip="下载器会在作品缩略图上显示一些按钮，你可以设置它们显示在缩略图的左侧还是右侧。">
...
<div class="option" data-no="40" style="display: flex;"><button type="button" class="pinButton" data-title="_置顶">📌</button>
      <a href="https://xuejianxianzun.github.io/PBDWiki/#/zh-cn/设置-更多-增强?flag=40" target="_blank" class="settingNameStyle" data-xztext="_在作品缩略图上显示放大按钮">在作品缩略图上显示<span class="key">放大</span>按钮</a>
