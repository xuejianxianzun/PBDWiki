...
?> 下面的步骤讲的是在 PC 上进行安装。如果你想要在 Android 上安装，请查看：[在 Microsoft Edge Canary 浏览器上安装](/zh-cn/%E5%AE%89%E8%A3%85/MicrosoftEdgeCanary)
...
- 不要删除硬盘上已解压的 powerfulpixivdownloader 文件夹，否则扩展将无法运行。
