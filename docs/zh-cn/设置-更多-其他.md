...
<p class="option" data-no="93" style="display: flex;">
      <a href="https://xuejianxianzun.github.io/PBDWiki/#/zh-cn/设置-更多-其他?flag=93" target="_blank" class="has_tip settingNameStyle" data-xztip="_日志区域的默认可见性的说明" data-tip="当下载器在页面顶部输出日志时，你可以控制日志区域默认显示还是隐藏。">
