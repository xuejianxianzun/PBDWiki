...
<div class="option settingsPanel_optionCard" data-no="67" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=67" target="_blank" class="has_tip settingNameStyle" data-xztip="_小说保存格式的说明" data-tip="TXT 是纯文本文件。选择 TXT 格式时，小说里的图片会单独保存。&lt;br&gt;EPUB 是电子书格式，小说里的图片会内嵌到 EPUB 文件里。" data-bind-click="true">
...
<div class="option settingsPanel_optionCard" data-no="68" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=68" target="_blank" class="has_tip settingNameStyle" data-xztip="_在小说里保存元数据提示" data-tip="把小说的标题、作者、标签等信息保存到小说开头。" data-bind-click="true">
...
<div class="option settingsPanel_optionCard" data-no="69" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=69" target="_blank" class="settingNameStyle" data-xztext="_下载小说的封面图片" data-bind-click="true">下载小说的<span class="key">封面</span>图片</a>
...
<div class="option settingsPanel_optionCard" data-no="70" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=70" target="_blank" class="settingNameStyle" data-xztext="_下载小说里的内嵌图片" data-bind-click="true">下载小说里的<span class="key">内嵌</span>图片</a>
  ...
  <div class="subOptionWrap flexBasis100" data-show="downloadNovelEmbeddedImage" style="display: inline-flex;">
    <span class="mr4" data-xztext="_图片尺寸">图片尺寸</span>
    ...
    <span class="beautify_radio" tabindex="0"></span>
    <label for="novelEmbeddedImageSizeOriginal" data-xztext="_原图" class="active">原图</label>
...
注意：对于体积比较大的 PNG 格式内嵌图片，有些小说阅读器可能只会显示一部分。这是阅读器的问题，和下载器无关。
...
注意：即使你选择的图片尺寸小于 1200px，有些图片依然会使用 1200px 尺寸，这是正常的。原因是小说里的图片有两种：
1. 作者上传到小说里的图片，可以使用所有尺寸。
2. 从插画作品里引用的图片，可用的最小尺寸为 1200px。

## 自动合并系列小说

<div class="option settingsPanel_optionCard" data-no="71" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=71" target="_blank" class="has_tip settingNameStyle" data-xztip="_自动合并系列小说的说明" data-tip="抓取作品时，如果一个小说属于某个系列，就自动抓取这个系列里的所有小说并且合并。" data-bind-click="true">
...
<div class="option settingsPanel_optionCard" data-no="104" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=104" target="_blank" class="settingNameStyle" data-bind-click="true">
    <span data-xztext="_在合并系列小说时只要有一篇小说符合过滤条件就保存该系列里的所有小说">在合并系列小说时，只要有一篇小说符合<span class="key">过滤条件</span>，就保存该系列里的所有小说</span>
  </a>
  <input type="checkbox" name="saveAllSeriesNovelsIfOneMatches" class="need_beautify checkbox_switch">
  <span class="beautify_switch" tabindex="0"></span>
  <button type="button" class="textButton gray1 showMsgBtn" data-title="_在合并系列小说时只要有一篇小说符合过滤条件就保存该系列里的所有小说" data-msg="_在合并系列小说时只要有一篇小说符合过滤条件就保存该系列里的所有小说的提示" data-xztext="_帮助">帮助</button>
</div>

这个设置的使用场景：当你设置了一些过滤条件时，只要某个系列里有一篇小说符合要求，就合并这个系列里的所有小说。

举例说明：

假如你设置了收藏数量 > 100；某个系列里有 10 篇小说，其中只有 1 篇小说符合条件。

在默认情况下（未启用此设置），下载器只会合并 1 篇小说。如果你启用了这个设置，那么下载器会合并所有小说。

## 合并系列小说时的分割阈值

<div class="option settingsPanel_optionCard new" data-no="72" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/小说?flag=72" target="_blank" class="settingNameStyle" data-bind-click="true">
