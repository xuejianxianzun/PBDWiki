...
<div class="option settingsPanel_optionCard" data-no="64" data-pin-bound="true" style="display: flex;">
  <a href="/#/zh-cn/设置-下载/图片尺寸?flag=64" target="_blank" class="settingNameStyle" data-xztext="_下载图片时的尺寸" data-bind-click="true">下载插画、漫画、动图时的<span class="key">尺寸</span></a>
...
!> 当你选择了较小的尺寸，并且**文件数量很多**时，下载频率可能会非常快，例如 1 秒钟可能下载接近 10 个图片。此时建议你设置 [下载间隔](/zh-cn/设置-下载/下载行为?id=下载间隔) 时间，主动降低下载频率，否则可能会被 Pixiv 警告。
