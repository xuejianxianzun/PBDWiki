...
<p class="option new" data-no="15">
  <a class="has_tip settingNameStyle" data-xztip="_必须大于0" data-tip="必须大于 0">
...
如果设置为 1，下载器就只会抓取每个用户的最新的 1 个作品。

----------

这是红叶赞助的非公开功能，因此它在公开版本里总是会隐藏。

如果你想看到这个设置，可以这样操作：

1. 启用下载器的“显示高级设置”选项，并切换到下载器的“更多”选项卡。
2. 按 F12 审查元素，在“元素”面板里按 `Ctrl` + `F` 并搜索 `p[data-no="15"]` 就可以定位到这个元素。
